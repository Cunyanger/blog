    ...
    children: [
      {
        ...
        children: [
          ...
          { text: "Head First设计模式", icon: "book", link: "2" },
          { text: "计算机网络：自顶向下方法", icon: "book", link: "2" },
          { text: "On Java 8", icon: "book", link: "2" },
          { text: "Effective Java", icon: "book", link: "2" },
          { text: "SQL 反模式", icon: "book", link: "2" },
          { text: "敏捷软件开发：原则、模式与实践", icon: "book", link: "2" },
          { text: "JavaScript高级程序设计", icon: "book", link: "2" },
          { text: "JavaScript权威指南", icon: "book", link: "2" },
          { text: "鸟哥的Linux私房菜", icon: "book", link: "2" },
        ],
      },
      {
        text: "社科",
